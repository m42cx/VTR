...
public:
    CMainParams() {
        ...
        vout.resize(1);
        vout[0].SetEmpty();
        CTransaction txNew(1, 1522617020, vin, vout, 0);
        ...
        genesis.nVersion = 1;
        genesis.nTime    = 1522617020;
		    genesis.nBits = 520159231; // bnProofOfWorkLimit.GetCompact();
        genesis.nNonce   = 26854;

        hashGenesisBlock = genesis.GetHash();

       assert(hashGenesisBlock == uint256("0x0000d7cf1fbdb512f981d9aa5c2984266a6950a9ee9bd7b0c8a1889c6797cb0b"));
       assert(genesis.hashMerkleRoot == uint256("0xba5dcef08de515dbf7b1911e0b4eafda461cf1425644abbda5a7931f3bcb05c2"));
...
//	
        ...
        vSeeds.push_back(CDNSSeedData("0",  "185.205.210.136"));
        vSeeds.push_back(CDNSSeedData("1",  "185.206.145.130"));
	    	vSeeds.push_back(CDNSSeedData("2", "185.206.144.121"));
        ...
        nLastPOWBlock = 1000; //for test, real 10000
        nPOSStartBlock = 101;
    }
