...
QT_MOC_LITERAL(13, 231, 11), // "removeEntry"
QT_MOC_LITERAL(14, 243, 5), // "entry"
QT_MOC_LITERAL(15, 249, 34), // "on_createTransactionButton_cl..."
QT_MOC_LITERAL(16, 284, 26), // "on_transaction_textChanged"
QT_MOC_LITERAL(17, 311, 32), // "on_copyTransactionButton_clicked"
QT_MOC_LITERAL(18, 344, 33), // "on_pasteTransactionButton_cli..."
QT_MOC_LITERAL(19, 378, 32), // "on_signTransactionButton_clicked"
QT_MOC_LITERAL(20, 411, 38), // "on_copySignedTransactionButto..."
QT_MOC_LITERAL(21, 450, 32), // "on_sendTransactionButton_clicked"
QT_MOC_LITERAL(22, 483, 13) // "updateAmounts"
...
static const uint qt_meta_data_MultisigDialog[] = {
 ...
 // slots: name, argc, parameters, tag, flags
      ...
      10,    0,  114,    3, 0x08 /* Private */,
      11,    0,  115,    3, 0x08 /* Private */,
      12,    0,  116,    3, 0x08 /* Private */,
      13,    1,  117,    3, 0x08 /* Private */,
      15,    0,  120,    3, 0x08 /* Private */,
      16,    0,  121,    3, 0x08 /* Private */,
      17,    0,  122,    3, 0x08 /* Private */,
      18,    0,  123,    3, 0x08 /* Private */,
      19,    0,  124,    3, 0x08 /* Private */,
      20,    0,  125,    3, 0x08 /* Private */,
      21,    0,  126,    3, 0x08 /* Private */,
      13,    1,  127,    3, 0x08 /* Private */,
      13,    1,  130,    3, 0x08 /* Private */,
      22,    0,  133,    3, 0x08 /* Private */,
...
void MultisigDialog::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        case 0: { MultisigAddressEntry* _r = _t->addPubKey();
            if (_a[0]) *reinterpret_cast< MultisigAddressEntry**>(_a[0]) = std::move(_r); }  break;
        case 1: _t->clear(); break;
        case 2: _t->updateRemoveEnabled(); break;
        case 3: { MultisigInputEntry* _r = _t->addInput();
            if (_a[0]) *reinterpret_cast< MultisigInputEntry**>(_a[0]) = std::move(_r); }  break;
        ...
        case 8: _t->removeEntry((*reinterpret_cast< MultisigAddressEntry*(*)>(_a[1]))); break;
        case 9: _t->on_createTransactionButton_clicked(); break;
        case 10: _t->on_transaction_textChanged(); break;
        case 11: _t->on_copyTransactionButton_clicked(); break;
        case 12: _t->on_pasteTransactionButton_clicked(); break;
        case 13: _t->on_signTransactionButton_clicked(); break;
        case 14: _t->on_copySignedTransactionButton_clicked(); break;
        case 15: _t->on_sendTransactionButton_clicked(); break;
        case 16: _t->removeEntry((*reinterpret_cast< MultisigInputEntry*(*)>(_a[1]))); break;
        case 17: _t->removeEntry((*reinterpret_cast< SendCoinsEntry*(*)>(_a[1]))); break;
        case 18: _t->updateAmounts(); break;
        default: ;
        }
