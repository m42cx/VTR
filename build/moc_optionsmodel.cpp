...
QT_MOC_LITERAL(8, 131, 28) // "AnonymizeVentorAmountChanged"
...
void OptionsModel::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        case 5: _t->AnonymizeVentorAmountChanged((*reinterpret_cast< int(*)>(_a[1]))); break;
        default: ;
        }
        ...
        {
            typedef void (OptionsModel::*_t)(int );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&OptionsModel::AnonymizeVentorAmountChanged)) {
                *result = 5;
                return;
            }
        }
...
// SIGNAL 5
void OptionsModel::AnonymizeVentorAmountChanged(int _t1)
{
    void *_a[] = { nullptr, const_cast<void*>(reinterpret_cast<const void*>(&_t1)) };
