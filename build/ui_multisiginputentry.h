...
public:
    ...
    {
        MultisigInputEntry->setWindowTitle(QApplication::translate("MultisigInputEntry", "Form", nullptr));
#ifndef QT_NO_TOOLTIP
        transactionId->setToolTip(QString());
#endif // QT_NO_TOOLTIP
        transactionId->setPlaceholderText(QApplication::translate("MultisigInputEntry", "Enter a transaction id", nullptr));
#ifndef QT_NO_TOOLTIP
        pasteTransactionIdButton->setToolTip(QString());
#endif // QT_NO_TOOLTIP
        pasteTransactionIdButton->setText(QString());
#ifndef QT_NO_SHORTCUT
        pasteTransactionIdButton->setShortcut(QApplication::translate("MultisigInputEntry", "Alt+P", nullptr));
#endif // QT_NO_SHORTCUT
#ifndef QT_NO_TOOLTIP
        deleteButton->setToolTip(QString());
#endif // QT_NO_TOOLTIP
        deleteButton->setText(QString());
        transactionIdLabel->setText(QApplication::translate("MultisigInputEntry", "Transaction id:", nullptr));
        transactionOutputLabel->setText(QApplication::translate("MultisigInputEntry", "Transaction output:", nullptr));
        redeemScriptLabel->setText(QApplication::translate("MultisigInputEntry", "Redeem script:", nullptr));
#ifndef QT_NO_TOOLTIP
        redeemScript->setToolTip(QString());
#endif // QT_NO_TOOLTIP
        redeemScript->setPlaceholderText(QApplication::translate("MultisigInputEntry", "Enter the redeem script of the address in the transaction output", nullptr));
#ifndef QT_NO_TOOLTIP
        pasteRedeemScriptButton->setToolTip(QString());
#endif // QT_NO_TOOLTIP
        pasteRedeemScriptButton->setText(QString());
#ifndef QT_NO_SHORTCUT
        pasteRedeemScriptButton->setShortcut(QApplication::translate("MultisigInputEntry", "Alt+A", nullptr));
#endif // QT_NO_SHORTCUT
    } // retranslateUi
