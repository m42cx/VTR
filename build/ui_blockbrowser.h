...
public:
    ...
    {
        BlockBrowser->setWindowTitle(QApplication::translate("BlockBrowser", "Form", nullptr));
        label_5->setText(QApplication::translate("BlockBrowser", "<html><head/><body><p><span style=\" font-size:20px; font-weight:600; color:#000000;\">Block Explorer </span></p></body></html>", nullptr));
