...
public:
    ...
    void setupUi(QDialog *OptionsDialog)
    {
        ...
        anonymizeVentor = new QSpinBox(tabMain);
        anonymizeVentor->setObjectName(QStringLiteral("anonymizeVentor"));
        anonymizeVentor->setMinimum(2);
        anonymizeVentor->setMaximum(10000);
        anonymizeVentor->setSingleStep(10);
        anonymizeVentor->setValue(1000);

        gridLayout->addWidget(anonymizeVentor, 7, 1, 1, 1);
    ...
    void retranslateUi(QDialog *OptionsDialog)
    {
        ...
        bitcoinAtStartup->setToolTip(QApplication::translate("OptionsDialog", "Automatically start Ventor after logging in to the system.", nullptr));
#endif // QT_NO_TOOLTIP
        bitcoinAtStartup->setText(QApplication::translate("OptionsDialog", "&Start Ventor on system login", nullptr));
#ifndef QT_NO_TOOLTIP
...
#endif // QT_NO_TOOLTIP
        label_2->setText(QApplication::translate("OptionsDialog", "Amount of Ventor to keep anonymized", nullptr));
        tabWidget->setTabText(tabWidget->indexOf(tabMain), QApplication::translate("OptionsDialog", "&Main", nullptr));
#ifndef QT_NO_TOOLTIP
        mapPortUpnp->setToolTip(QApplication::translate("OptionsDialog", "Automatically open the Ventor client port on the router. This only works when your router supports UPnP and it is enabled.", nullptr));
#endif // QT_NO_TOOLTIP
        mapPortUpnp->setText(QApplication::translate("OptionsDialog", "Map port using &UPnP", nullptr));
#ifndef QT_NO_TOOLTIP
        connectSocks->setToolTip(QApplication::translate("OptionsDialog", "Connect to the Ventor network through a SOCKS5 proxy (e.g. when connecting through Tor).", nullptr));
#endif // QT_NO_TOOLTIP
...
#ifndef QT_NO_TOOLTIP
        lang->setToolTip(QApplication::translate("OptionsDialog", "The user interface language can be set here. This setting will take effect after restarting Ventor.", nullptr));
#endif // QT_NO_TOOLTIP
